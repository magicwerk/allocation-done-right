 ...
 */
public class Example_12_Inlining {

	static final Logger LOG = LogbackTools.getConsoleLogger();

	JavaVersion javaVersion = JavaVersion.JAVA_21;
	JdkCommands jdkTools = PresentationRunner.createJdkCommands(javaVersion);
	JavaTool javaTool = PresentationRunner.createJavaTool(javaVersion);

	int inliningStep = 3;

	public static void main(String[] args) {
		new Example_12_Inlining().run();
	}
	...
	void runJmh() {
		...
		new PresentationRunner().runBenchmark(Run_Inlining.class);
	}
	...
	void runInlining() {
		...
		jr.setMainMethod(Example_12_Inlining.class, "doRunInlining");
		jr.run();
	}
	...
	void doRunInlining() {
		...
		Run_Inlining check = new Run_Inlining();
	...
	public static class Run_Inlining {
		...
		@Benchmark
		public int callLargeMethodWithObjectSplitted() {
			int sum = 0;
			Object o = new Object();
			for (int i = 0; i < ITER1; i++) {
		...
		int largeMethodSplitted(int sum, Object o) {
			sum += largeMethodSplitted1(sum);
			sum += largeMethodSplitted2(sum);
			return sum;
		}

		int largeMethodSplitted1(int sum) {
			// Part 1
			for (int i = 0; i < ITER2; i++) {
				sum += i * i * i * i * i * i * i * i * i * i;
				sum += i * i * i * i * i * i * i * i * i * i;
		...
		int largeMethodSplitted2(int sum) {
			// Part 1
			for (int i = 0; i < ITER2; i++) {
				sum += i * i * i * i * i * i * i * i * i * i;
				sum += i * i * i * i * i * i * i * i * i * i;
