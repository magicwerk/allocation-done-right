...
public class PresentationHelper {
	...
	IList<JdkCommands> allJdkTools = GapList.create(
			createJdkTools(JavaVersion.JAVA_8),
	...
	public static JdkCommand createJavaJdkTool(JavaVersion jv) {
	...
	public static JdkCommand createJavacJdkTool(JavaVersion jv) {
	...
	void runMeasure(Class<?> clazz) {
		runMeasure(clazz, defaultJdkTools);
	}

	void runMeasure(Class<?> clazz, JdkCommands jt) {
		Options opts = createOptions(clazz, null);
		opts.setJavaVersions(GapList.create(jt));
	...
	public void runMeasureWithGc(Class<?> clazz) {
		Options opts = createOptions(clazz, null);
	...
	PresentationHelper setVerboseBuildJavac(boolean verboseBuildJavac) {
		this.verboseBuildJavac = verboseBuildJavac;
		return this;
	}

	PresentationHelper setForce(boolean force) {
		this.force = force;
		return this;
	}

	PresentationHelper setFastMode(boolean fastMode) {
		this.fastMode = fastMode;
		return this;
	}

	PresentationHelper setProfileGc(boolean profileGc) {
		this.profileGc = profileGc;
		return this;
	}

	PresentationHelper setProfileTime(boolean profileTime) {
		this.profileTime = profileTime;
		return this;
	}

	public PresentationHelper setRunTimeMillis(int runTimeMillis) {
		this.runTimeMillis = runTimeMillis;
		return this;
	}

	public PresentationHelper setFactorRow(boolean factorRow) {
